    ...
    return (
        <Container className="flex flex-col items-center">
            ...
            <div id="about" className="flex w-full justify-center items-center min-h-[370px]">
                <div className="flex gap-3 w-full justify-between" id="aboutContainer">
                    <div className="w-1/2 flex flex-col justify-around items-center" id="tecnologies">
                    ...
                    <div className="bg-sky-600 w-px min-h-[300px]"></div>
                    <div className="w-1/2 flex flex-col justify-around items-center" id="socials">
